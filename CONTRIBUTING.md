...
- **New subclasses.** If a drift you caught doesn't fit the eight subclasses cleanly, that's signal. Name it, describe the T1 framing, the T2 reality, and the verification step that caught it.
